...
export class InlineEditingComponent implements OnInit {
	...
	public staticLanguages: Array<string> = [
		'Albanian',
		'Amharic',
		'Aymara',
		'Bulgarian',
	...
	constructor(private http: HttpClient) {
		...
		this.http
			.get('https://private-730c61-generictable.apiary-mock.com/options')
		...
		this.configObject = {
			...
			fields: [
				...
				},
				{
					...
					value: () => {
						const langId = Math.floor(
							Math.random() * this.staticLanguages.length
						);
